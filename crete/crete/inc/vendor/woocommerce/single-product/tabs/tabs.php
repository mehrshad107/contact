...
<div class="accordion crete-p-accordion" id="xoopidescaccordion">
      	...
      	<?php if ($key == 'description'){
      	  ...
      	  <div class="accordion-item crete-p-accordion-items">
...
<?php } else { ?>
	<div class="woocommerce-tabs wc-tabs-wrapper crete-vertical-tabs">
		...
		<div class="crete-woo-tab-contents">
		<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
